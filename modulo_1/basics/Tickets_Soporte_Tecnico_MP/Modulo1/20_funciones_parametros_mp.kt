fun main() {
    ...
    // Llamadas usando diferentes combinaciones de parametros
    ...
    // Argumentos nombrados (permite cambiar el orden)
    println(registrarTicket(prioridad = 3, asunto = "Recuperar clave", esUrgente = false))
}

fun registrarTicket(
    asunto: String,
    prioridad: Int = 4,      // Valor por defecto: Prioridad baja
    area: String = "General", // Valor por defecto: Area general
    esUrgente: Boolean = false // Valor por defecto: No urgente
): String {
